...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.MyViewHolder> implements Filterable {
    ...
    public ProductAdapter(Context context, List<Product> OriginalList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        Picasso.get().load(BaseURL.IMAGE_PATH+ product.getProduct_image()).placeholder(R.drawable.ic_default_small_product).into(holder.product_image);
