...
public class AllUsers extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQ_CODE_SPEECH_INPUT) {
            if (resultCode == RESULT_OK && null != data) {
                ...
                assert result != null;
                usersAdapter.getFilter().filter(result.get(0));
    ...
    private void clickListener() {
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(getApplicationContext(),AddSurveyor.class);
    ...
    private void recyclerView() {
        ...
        usersAdapter = new UsersAdapter(AllUsers.this, usersList);
    ...
    private void getUserList() {
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, BaseURL.USERS_LIST,
    ...
    private void setResponse(String response) {
        ...
        if (!response.isEmpty()){
            ...
            List<Users> items = gson.fromJson(response, listType);
            usersList.clear();
