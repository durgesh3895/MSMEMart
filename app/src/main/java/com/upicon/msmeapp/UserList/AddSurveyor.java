package com.upicon.msmeapp.UserList;
...
import com.upicon.msmeapp.BasicActivities.Login;
...
public class AddSurveyor extends AppCompatActivity implements  android.view.View.OnFocusChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_surveyor);
    ...
    private void addSurveyor() {
        final ProgressDialog pd=new ProgressDialog(AddSurveyor.this);
    ...
    private void SetUserResponse(String response) {
        ...
        try {
            ...
            if(obj.get("Response").equals(true)){
                UtilsMethod.INSTANCE.successToast(AddSurveyor.this,obj.getString("Message"));
                ...
                UtilsMethod.INSTANCE.errorToast(AddSurveyor.this,obj.getString("Message"));
            }
            else {
                UtilsMethod.INSTANCE.errorToast(AddSurveyor.this,"Something went wrong");
            }
    ...
    public void onFocusChange(android.view.View view, boolean b) {
        if (!b){
            UtilsMethod.INSTANCE.hideKeyboard(AddSurveyor.this,view);
        }
    }
}